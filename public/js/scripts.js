  ...
  //     this.innerHTML = hide ? 'Show Less' : 'Show More'
  // })
...
//   alert("AA")
//   document.getElementById("more").addClass("show-more");
// })

// function show(){
//   if(document.getElementById("more").className === "show-less"){
//     document.getElementById("more").className =+ "show-more";
//  }
//   else{
//     document.getElementById("more").className = "show-less";
//   }
// }
...
//   var checkbox1 = document.getElementById('product1check');
//   localStorage.setItem('product1check', checkbox1.checked);
// }

// function load(){    
//   var checked1 = JSON.parse(localStorage.getItem('product1check'));
//   document.getElementById("product1check").checked = checked1;
// }

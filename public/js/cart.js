...
// exports.addProduct = (divId) => {
//    var product_name = $('#'+divId).find('.card-title').text();
//    var product_price = $('#'+divId).find('.price').text();
//    var product_image = $('#'+divId).find('.card-img-top').attr('src');
